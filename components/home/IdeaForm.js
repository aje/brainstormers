				...
				<main className={"flex items-center"}>
					<form onSubmit={onSubmit} className="w-3/5 pr-20">
						<h2 className={"mb-6 font-sans"}>
							...
							<span className={"font-normal  font-serif"}>and ask other people's opinion</span>
						</h2>
						<Textarea
							required
							onChange={onChange}
						...
						<div className="flex items-center">
							<Button type={"submit"} icon={<Plus size={32} />} className={"z-0 uppercase font-bold bg-blue-500"} size={"lg"}>
								Add idea
							</Button>
