            ...
            <Container >
                <main className={"flex items-center"}>
                    <div className="w-3/5 pr-20">
                        <h2 className={"mb-6 font-sans"} >Write your <span className={"text-blue-400"}>idea</span> down <span className={"font-normal  font-serif"}>and ask other people's opinion</span></h2>
                        <Textarea bordered className={"mb-6 bg-white"} placeholder={"Something that makes ..."} fullWidth  size={"xl"} />
                        <div className="flex items-center">
                            <Button icon={<Plus size={32}/>}  className={" uppercase font-bold bg-blue-500"} size={"lg"}>Add idea</Button>
