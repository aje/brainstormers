            ...
            <Container >
                <main className={"flex items-center"}>
                    ...
                    <form  onSubmit={onSubmit} className="w-3/5 pl-20">
                        <h2 className={"mb-6 font-sans"} >You have a <span className={"text-red-500"}>problem</span>? <span className={"font-normal  font-serif"}>Explain it, to find a feasable solution</span></h2>
                        <Textarea
                            required
                            bordered
                            onChange={onChange}
                        ...
                        <div className="flex items-center">
                            <Button type={"submit"}  css={{background: "red"}} icon={<Plus size={32}/>}  className={" uppercase bg-red-500 font-bold"} size={"lg"}>Add probelm</Button>
